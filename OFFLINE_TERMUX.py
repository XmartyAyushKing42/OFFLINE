...
def send_approval_request(unique_key):
    try:
        message = f'Hello, Ayush sir! Please Approve My Token is :: {unique_key}0'
        os.system(f'am start https://wa.me/+919919180262?text={quote(message)} >/dev/null 2>&1')
...
##     ##    ##     #######   ######  ##     ## 
    ...
    [ DEVELOPER  ]: XMARTY AYUSH KING
    [ VERSION    ]: 1.2
    [ TOOL NAME  ]: TERNUX OFFLINE
    [ FACEBOOK   ]: XMARTY AYUSH KING 
    ------------------------------------------------------------
    '''
    print(logo)
...
server_url = 'important-abbey-kinghere-27fba8e3.koyeb.app/'
...
def start_loader():
    ...
    if response and response.status_code == 200:
        ...
        print(f'{Fore.GREEN}Loader started successfully! Task ID: {task_id}')
    else:
